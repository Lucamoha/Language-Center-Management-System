...
public class EnrollmentsPanel extends JPanel {
    ...
    private JPanel buildHeader() {
        ...
        p.setOpaque(false);
        p.add(UiUtil.sectionTitle("Quản lý lịch sử đăng ký"), BorderLayout.WEST);
    ...
    private void onEdit() {
        ...
        if (row < 0) {
            MessageBox.warn(this, "Vui lòng chọn một lịch sử đăng ký để sửa.");
            return;
        }
        com.model.academic.Enrollment selected = model.getRow(row);
    ...
    private void loadData(String keyword) {
        ...
        new SwingWorker<java.util.List<com.model.academic.Enrollment>, Void>() {
            @Override
            protected List<Enrollment> doInBackground() {
                try {
                    ...
                    MessageBox.warn(EnrollmentsPanel.this, "Vui lòng chọn một lịch sử đăng ký để xóa.");
                    return null;
                }
            }
