...
public class EnrollmentTableModel extends AbstractTableModel {
    private static final String[] COLUMNS = {
            "Mã đăng ký", "Mã học viên", "Tên học viên", "Mã lớp học", "Tên lớp học", "Trạng thái"
    };
    ...
    public Object getValueAt(int row, int col) {
        ...
        return switch (col) {
            ...
            case 3 -> e.getAclass() != null ? e.getAclass().getClassID() : "";
            case 4 -> e.getAclass() != null ? e.getAclass().getClassName() : "";
            case 5 -> e.getStatus() != null ? e.getStatus() : "";
            default -> "";
        };
    }
}
